...
function gameLoop() {
  ...
  if ((430 < x) && (x < 580)) { // if player x (horizontal) pos is between 440 and 580 px
    ...
    // Platform 2 Bounds
  if ((630-10 < x) && (x < 660)) { // if player x (horizontal) pos is between 440 and 580 px
    if ((y > 587-20) && y < 609) { // if player y (vertical) pos is between 591 and 623 px
      if ((y + gravity) > 587-20) {
        gravity = 0;
        y = 587-20;
        noPlatform = false;
    ...
    // Platform 3 Bounds
  if ((696-10 < x) && (x < 726)) { // if player x (horizontal) pos is between 440 and 580 px
    if ((y > 546-20) && y < 568) { // if player y (vertical) pos is between 591 and 623 px
      if ((y + gravity) > 546-20) {
        gravity = 0;
        y = 546-20;
        noPlatform = false;
